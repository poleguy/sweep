...
# this password comes from OBS Tools->WebSocket Server Settings->Sever Password
# This must be enabled: OBS Tools->WebSocket Server Settings->Enable WebSocket server
on_active = "obs-cli -p mrnSTlSSX1xl5aBD -P 4455 -H 192.168.1.162 virtualcam start"
on_idle = "obs-cli -p mrnSTlSSX1xl5aBD -P 4455 -H 192.168.1.162 virtualcam stop"
